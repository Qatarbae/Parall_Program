...
int main() {
    ...
    if (f) {
        printf("\nРџСЂРѕРёР·РІРѕРґРёС‚СЃСЏ СЃС‡РёС‚С‹РІР°РЅРёРµ РјР°С‚СЂРёС†С‹ РёР· С„Р°Р№Р»Р°. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РїРѕРґРѕР¶РґРёС‚Рµ...\n");
        // РќР°С…РѕРґРёРј СЂР°Р·РјРµСЂРЅРѕСЃС‚СЊ РјР°С‚СЂРёС†С‹
        int str, str2;
        fread(&str, sizeof(int), 1, f);
        fread(&str2, sizeof(int), 1, f);
        n = str;
	printf("%d\n", n);
        arr = CreateArray(str); // РЎРѕР·РґР°РЅРёРµ РјР°С‚СЂРёС†С‹ РїРѕ СЃС‡РёС‚Р°РЅРЅС‹Рј СЂР°Р·РјРµСЂР°Рј
                              // Р—Р°РїРёСЃСЊ РІ РјР°С‚СЂРёС†Сѓ Р·РЅР°С‡РµРЅРёР№ РёР· С„Р°Р№Р»Р°
        for (int i = 0; i < str; i++) {
   ...
   //РЎС‚СЂСѓРєС‚СѓСЂС‹ РґР»СЏ СЃРѕС…СЂР°РЅРµРЅРёСЏ РѕРїСЂРµРґРµР»РµРЅРЅРѕРіРѕ РІСЂРµРјРµРЅРё
   struct timespec mt1, mt2; 
   
   //РћРїСЂРµРґРµР»СЏРµРј С‚РµРєСѓС‰РµРµ РІСЂРµРјСЏ
